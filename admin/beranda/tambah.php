...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO beranda (id_admin, judul, deskripsi, gambar) 
                                  VALUES ('$id_admin', '$judul', '$deskripsi', '$gambar')");

    if ($query) {
        echo "<script>
                alert('Data beranda berhasil ditambahkan');
                window.location='index.php';
              </script>";
    } else {
        echo "<script>
                alert('Data beranda gagal ditambahkan');
              </script>";
    }
}
?>
    ...
    <section class="admin-content">
        ...
        <div class="admin-data-box">
            ...
            <div class="admin-data-header">
                <h2>Form Tambah Konten Beranda</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-admin-group">
                    <label>Judul</label>
                    <input type="text" name="judul" placeholder="Masukkan judul beranda" required>
                </div>

                <div class="form-admin-group">
                    <label>Deskripsi</label>
                    <textarea name="deskripsi" rows="7" placeholder="Masukkan deskripsi beranda" required></textarea>
                </div>
