...
if (!$data) {
    echo "<script>
            alert('Data peran tenun tidak ditemukan');
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($conn, "UPDATE peran_tenun SET
                                    id_admin='$id_admin',
                                    judul='$judul',
                                    isi='$isi',
                                    gambar='$gambar'
    ...
    if ($update) {
        echo "<script>
                alert('Data peran tenun berhasil diperbarui');
                window.location='peran.php';
              </script>";
    } else {
        echo "<script>
                alert('Data peran tenun gagal diperbarui');
              </script>";
    }
}
?>
...
<main class="admin-main">
    ...
    <section class="admin-content">
        ...
        <h1>Edit Peran Tenun</h1>

        <div class="admin-data-box">

            <div class="admin-data-header">
                <h2>Form Edit Peran Tenun</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-admin-group">
                    ...
                    <?php if (!empty($data['gambar'])) : ?>
                        <img src="/uploads/peran/<?= htmlspecialchars($data['gambar']); ?>"
