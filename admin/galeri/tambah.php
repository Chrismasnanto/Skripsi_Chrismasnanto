...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO galeri (id_admin, judul, gambar, keterangan)
                                  VALUES ('$id_admin', '$judul', '$gambar', '$keterangan')");
    ...
    <section class="admin-content">
        ...
        <div class="admin-data-box">
            ...
            <div class="admin-data-header">
                <h2>Form Tambah Konten Galeri</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-admin-group">
                    <label>Judul</label>
                    <input type="text" name="judul" placeholder="Masukkan judul galeri" required>
                </div>

                <div class="form-admin-group">
                    <label>Keterangan</label>
                    <textarea name="keterangan" rows="8" placeholder="Masukkan keterangan galeri" required></textarea>
                </div>
