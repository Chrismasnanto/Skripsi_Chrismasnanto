                                ...
                                <tr>
                                    <td>
                                        <?php if (!empty($row['gambar'])) : ?>
                                            <img src="/uploads/proses/<?= htmlspecialchars($row['gambar']); ?>"
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="edit.php?id=<?= $row['id_proses']; ?>" class="btn-action">
                                                <i class="bi bi-pencil"></i>
                                            </a>

                                            <a href="hapus.php?id=<?= $row['id_proses']; ?>"
                                               class="btn-action"
                        ...
                        <?php else : ?>
                            ...
                            <tr>
                                <td colspan="4" class="text-center">
                                    Data proses pembuatan belum tersedia.
                                </td>
                            </tr>
