...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($conn, "UPDATE proses_pembuatan SET
                                    id_admin='$id_admin',
                                    judul='$judul',
                                    isi='$isi',
                                    gambar='$gambar'
    ...
    if ($update) {
        echo "<script>
                alert('Data proses pembuatan berhasil diperbarui');
                window.location='index.php';
              </script>";
    } else {
        echo "<script>
                alert('Data proses pembuatan gagal diperbarui');
              </script>";
    }
}
?>
...
<main class="admin-main">
    ...
    <section class="admin-content">
        ...
        <h1>Edit Proses Pembuatan</h1>

        <div class="admin-data-box">

            <div class="admin-data-header">
                <h2>Form Edit Konten Proses Pembuatan</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-admin-group">
                    ...
                    <?php if (!empty($data['gambar'])) : ?>
                        <img src="/uploads/proses/<?= htmlspecialchars($data['gambar']); ?>"
